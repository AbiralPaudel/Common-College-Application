                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('college.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" placeholder="(Format: Municipality/VDC - wardNo, District)" autocomplete="address">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="speciality1" type="checkbox" name="speciality[]" value="Academic"><label for="speciality1"> Academic </label><br>
                                <input id="speciality2" type="checkbox" name="speciality[]" value="Sports"><label for="speciality2"> Sports </label><br>
                                <input id="speciality3" type="checkbox" name="speciality[]" value="ECA"><label for="speciality3"> ECA </label><br>
                                <input id="speciality4" type="checkbox" name="speciality[]" value="Leadership"><label for="speciality4"> Leadership </label>
                            @error('speciality')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
